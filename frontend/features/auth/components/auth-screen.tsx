  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(0,173,181,0.18),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(57,62,70,0.32),transparent_28%),linear-gradient(180deg,#222831_0%,#393E46_100%)] px-4 py-10 md:px-8">
      ...
      <section className="relative mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <Card className="overflow-hidden border-(--line) bg-[linear-gradient(135deg,#222831_0%,#393E46_62%,#00ADB5_100%)] text-foreground">
          <CardContent className="grid min-h-140 content-between gap-12 p-8 md:p-12">
        ...
        <Card className="border-(--line) bg-[rgba(57,62,70,0.82)]">
          <CardContent className="p-6 md:p-8">
            ...
            {authError ? (
              <p className="mt-4 rounded-2xl border border-[rgba(166,41,41,0.15)] bg-[rgba(166,41,41,0.08)] px-4 py-3 text-sm font-medium text-(--danger)">
                {authError}
              </p>
            ) : null}
          </CardContent>
